...
func main() {
	...
	r.GET("/ping", func(c *gin.Context) {
		timer := prometheus.NewTimer(latencyHistogram.WithLabelValues("ping"))
	...
	r.POST("/upload", func(c *gin.Context) {
		timer := prometheus.NewTimer(requestDuration.WithLabelValues("upload"))
	...
	r.GET("/download/:size", func(c *gin.Context) {
		...
		timer := prometheus.NewTimer(requestDuration.WithLabelValues("download"))
		defer timer.ObserveDuration()
